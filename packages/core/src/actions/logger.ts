...
export interface ILoggingConfig {
    ...
    enabled: boolean;
    maxLogs?: number;
    filter?: (action: KarmycAction) => boolean;
}
...
export class ActionLogger {
    ...
    private shouldLog(action: KarmycAction, level: LogLevel): boolean {
    ...
    private log(level: LogLevel, message: string, action?: KarmycAction, error?: Error, metadata?: Record<string, unknown>): void {
    ...
    debug(message: string, action?: KarmycAction, metadata?: Record<string, unknown>): void {
        this.log(LogLevel.DEBUG, message, action, undefined, metadata);
    }

    info(message: string, action?: KarmycAction, metadata?: Record<string, unknown>): void {
        this.log(LogLevel.INFO, message, action, undefined, metadata);
    }

    warn(message: string, action?: KarmycAction, metadata?: Record<string, unknown>): void {
        this.log(LogLevel.WARN, message, action, undefined, metadata);
    }

    error(message: string, action?: KarmycAction, error?: Error, metadata?: Record<string, unknown>): void {

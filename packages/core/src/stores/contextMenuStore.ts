import { validatePosition } from '@gamesberry/karmyc-shared';
import { create } from 'zustand';
import { immer } from 'zustand/middleware/immer';
import {
    ContextMenuItem,
    IContextMenuPosition,
    OpenCustomContextMenuOptions,
...
interface ContextMenuState {
    ...
    openCustomContextMenu: (options: OpenCustomContextMenuOptions) => void;
...
export const useContextMenuStore = create<ContextMenuState>()(
    immer((set) => ({
        ...
        openCustomContextMenu: (options) =>
            set((state) => {
                state.isVisible = true;
                state.customContextMenu = options;
